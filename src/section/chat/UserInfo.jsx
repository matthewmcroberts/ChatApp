  ...
  return (
    <div className="border-l flex flex-col h-full border-stroke dark:border-strokedark ">
      ...
      <div className="px-6 space-y-1">
        <div className="text-black dark:text-white text-xl font-medium">Blake Jonathan</div>
      ...
      <div className="px-6 flex flex-row space-x-2">
        ...
        <button className="border border-stroke dark:border-strokedark p-2  rounded-md items-center justify-center">
