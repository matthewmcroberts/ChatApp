    ...
    return (
        <div className='hidden h-full flex-col xl:flex xl:w-1/4'>
            <div className='sticky border-b border-stroke dark:border-strokedark px-6 py-7.5 flex flex-row'>
                ...
                <span className='rounded-md border-[.5px] border-stroke dark:border-strokedark bg-green px-2 py-0.5 text-base font-medium text-black dark:bg-boxdark-2 dark:text-white 2xl:ml-4'>
                    8
                </span>
            </div>
            ...
            <div className='flex max-h-full flex-col overflow-auto p-5'>
                <form className='sticky mb-7'>
                    <input placeholder="Search..." type="text" className="w-full rounded border border-stroke bg-gray-2 py-5 pl-5 pr-10 text-sm outline-none focus:border-primary dark:border-strokedark dark:bg-boxdark-2" />
                        ...
                        return (
                            <div className={`flex cursor-pointer items-center rounded px-4 py-2 dark:hover:bg-strokedark ${selected === index ? "bg-gray dark:bg-boxdark-2 dark:hover:bg-boxdark-2" : "hover:bg-gray-2 dark:hover:bg-boxdark-2/90"}`} key={index} onClick={() => {setSelected(index);}}>
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-">{object.message}</p>
                                </div>
                            </div>
                        );
                    })}
